...
/**
 * Spring-data-redis中conn.set(String, String)被弃用，要使用conn.stringCommands().set(String, String)，可以自定义redisTokenStore，
 * 将{@link org.springframework.security.oauth2.provider.token.store.redis.RedisTokenStore}中所有<code>conn.set(String, String)</code>
 * 修改为<code>conn.stringCommands().set(String, String)</code>
 * @Author kzh
 * @Description
 * @Date 19-4-15 下午2:40
 */
